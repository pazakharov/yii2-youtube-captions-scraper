...
class YoutubeScraperTest extends \Codeception\Test\Unit
{
    /**
     * @var \UnitTester
     */
    ...
    public function testClientInstance()
    {
        ...
        expect($scraper->client)->isInstanceOf(Client::class);
    }
    ...
    public function testGetCaptionsBaseUrl()
    {
        ...
        $url = $scraper->getCaptionsBaseUrl('https://www.youtube.com/watch?v=wNzql5TZ-iY');
        expect($url)->string();
    }
